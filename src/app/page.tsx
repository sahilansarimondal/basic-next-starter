  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center min-h-screen">
        <Hero
          capsuleText="Fast & Secure"
          capsuleLink="http://localhost:3000"
          title="A Multi-tenant Next.js Starter Template"
          subtitle="Built for developers, by developers. Next.js + Shadcn UI + Auth.js."
          primaryCtaText="Get Started"
          primaryCtaLink={"http://localhost:3000"}
          secondaryCtaText="GitHub"
          secondaryCtaLink="http://localhost:3000"
          credits={
            <>
              Crafted with ❤️ by{" "}
              <a
        ...
        />
        <Footer
          builtBy="Sahil Ansari"
          builtByLink="http://localhost:3000"
          githubLink="http://loalhost:3000"
